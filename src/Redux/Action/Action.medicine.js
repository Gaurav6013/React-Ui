...
import { addMedicineData, deleteMedicineData, getAllMedicinesData, postMedicineData, putMedicineData } from '../../common/apis/Medicines.apis'
...
export const UpdateData = (data) =>(dispatch) =>{
  ...
  try{
    ...
    .then((data) =>dispatch({type :AT.UPDATE_DATA, payload:data.data}))
